...
export const AUDIT_ACTIONS = {
  ...
  classRoomsSplit: 'class.rooms_split',
  classHeadAbsent: 'class.head_absent',
  classMentorAbsent: 'class.mentor_absent',
  chapterMeetingUrlSet: 'chapter.meeting_url_set',
  ...
  parentMessageSent: 'parent_message.sent',
  mentorMeetingCreated: 'mentor_meeting.created',
  mentorMeetingRequested: 'mentor_meeting.requested',
  mentorMeetingRequestApproved: 'mentor_meeting.request_approved',
  mentorMeetingRequestDeclined: 'mentor_meeting.request_declined',
